...
namespace FIMSpace.FTail
{
    ...
    public abstract class FTail_AnimatorBase : MonoBehaviour
    {
        ...
        protected Vector3 SpringinessCalculations(FTail_Point tailPoint, Vector3 targetPosition)
        {
            if (Springiness > 0f)
            {
                Vector3 backPosDiff = tailPoint.Position - tailPoint.PreviousPosition;
                ...
                //if (LookUpMethod != FELookUpMethod.Parental) otherLocalToWorld = Matrix4x4.TRS(tailPoint.BackPoint.Transform.position, tailPoint.BackPoint.Transform.rotation, Vector3.one);
                ...
                //tailPoint.SpringOffset2 = Vector3.Lerp(tailPoint.SpringOffset2, offset, deltaTime * (5f + Springiness * 4f));
                newPos += offset;
