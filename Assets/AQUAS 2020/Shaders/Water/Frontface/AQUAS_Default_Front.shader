Shader "AQUAS/Desktop/Front/Default"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult1_g621 = (float2(0.15 , 0.0));
			float2 temp_output_1640_0 = ( (IntersectionPoint1592).xz * 0.5 );
			float2 panner3_g621 = ( _Time.y * appendResult1_g621 + temp_output_1640_0);
			float2 temp_output_1643_0 = panner3_g621;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 appendResult1_g582 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g582 = ( _Time.y * appendResult1_g582 + rotator30);
			float normalStrength681 = _NormalStrength;
			float3 lerpResult67 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g587 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g582 ) ) ) , normalStrength681);
			...
			float4 screenColor86_g651 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,( (ase_screenPosNorm).xy + ( float2( 0.2,0 ) * refraction511 ) ));
			float3 LightWrapVector47_g651 = (( _LightWrapping * 0.5 )).xxx;
			float2 appendResult1_g581 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g581 = ( _Time.y * appendResult1_g581 + temp_output_1324_0);
			float2 appendResult1_g580 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g580 = ( _Time.y * appendResult1_g580 + rotator1327);
			float3 lerpResult1333 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g581 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g580 ) ) ) , normalStrength681);
			...
			float2 appendResult1_g503 = (float2(0.2 , 0.0));
			...
			float2 panner3_g503 = ( _Time.y * appendResult1_g503 + rotator1177);
			float4 ShorelineNormal817 = ( float4( lerpResult824 , 0.0 ) * ( 1.0 - step( tex2DNode912.r , _ShorelineBlend ) ) * ( ( tex2D( _RandomMask, uv_RandomMask ) + tex2D( _RandomMask, panner3_g503 ) ) / 2.0 ) );
			float4 NormalsClose1340 = ( float4( lerpResult1338 , 0.0 ) + ShorelineNormal817 );
			float temp_output_678_0 = ( waveSpeed675 / 10.0 );
			float2 appendResult1_g586 = (float2(temp_output_678_0 , 0.0));
			...
			float2 panner3_g586 = ( _Time.y * appendResult1_g586 + temp_output_1347_0);
			...
			float3 lerpResult639 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g586 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g584 ) ) ) , normalStrengthMedium706);
			float3 WavesMediumUv1640 = lerpResult639;
			float temp_output_1362_0 = ( waveSpeed675 / 10.0 );
			float2 appendResult1_g583 = (float2(temp_output_1362_0 , 0.0));
			...
			float2 panner3_g583 = ( _Time.y * appendResult1_g583 + temp_output_1360_0);
			float2 appendResult1_g585 = (float2(temp_output_1362_0 , 0.0));
			...
			float2 panner3_g585 = ( _Time.y * appendResult1_g585 + rotator1361);
			float3 lerpResult1367 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g583 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g585 ) ) ) , normalStrengthMedium706);
			...
			float2 appendResult1_g623 = (float2(temp_output_680_0 , 0.0));
			float2 temp_output_1201_0 = ( BaseUV1197 * ( normalTiling618 / 1200.0 ) );
			float2 panner3_g623 = ( _Time.y * appendResult1_g623 + temp_output_1201_0);
			...
			float3 lerpResult657 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g623 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g625 ) ) ) , normalStrengthFar704);
			...
			float3 appendResult4_g646 = (float3(( ( (lerpResult670.rgb).xy * NormalSign1123 ) + WorldNormalXZ1122 ) , WorldNormalY1121));
			...
			float3 break1470 = worldToTangentDir6_g646;
			float temp_output_32_0_g633 = ( -0.02 / ( _Scale0 / 30.0 ) );
			...
			float2 temp_output_1_0_g633 = appendResult17_g626;
			float4 tex2DNode8_g633 = tex2D( _RippleTex0, ( ( temp_output_32_0_g633 * float2( 0,1 ) ) + temp_output_1_0_g633 ) );
			float temp_output_17_0_g633 = ( ( tex2D( _RippleTex0, ( ( float2( 1,0 ) * temp_output_32_0_g633 ) + temp_output_1_0_g633 ) ).r - tex2DNode8_g633.r ) * 1.0 );
			float temp_output_18_0_g633 = ( 1.0 * ( tex2DNode8_g633.r - tex2D( _RippleTex0, temp_output_1_0_g633 ).r ) );
			float2 appendResult21_g633 = (float2(temp_output_17_0_g633 , temp_output_18_0_g633));
			float3 appendResult27_g633 = (float3(( -appendResult21_g633 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g633 , 1.0 ) ) - pow( temp_output_18_0_g633 , 1.0 ) ) )));
			float3 normalizeResult28_g633 = normalize( appendResult27_g633 );
			float2 appendResult37_g626 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g626 = ase_worldNormal;
			float3 appendResult4_g639 = (float3(( ( (normalizeResult28_g633).xy * appendResult37_g626 ) + (temp_output_30_0_g626).xz ) , (temp_output_30_0_g626).y));
			float3 worldToTangentDir6_g639 = normalize( mul( ase_worldToTangent, (appendResult4_g639).xzy) );
			float temp_output_32_0_g632 = ( -0.02 / ( _Scale1 / 30.0 ) );
			float temp_output_1_0_g624 = _Scale1;
			float Scale10_g624 = temp_output_1_0_g624;
			float2 break12_g624 = ( ( (ase_worldPos).xz + ( float2( 0.5,0.5 ) * temp_output_1_0_g624 ) ) * ( 1.0 / temp_output_1_0_g624 ) );
			float2 appendResult17_g624 = (float2(( ( _XOffset1 / Scale10_g624 ) + break12_g624.x ) , ( break12_g624.y + ( _ZOffset1 / Scale10_g624 ) )));
			float2 temp_output_1_0_g632 = appendResult17_g624;
			float4 tex2DNode8_g632 = tex2D( _RippleTex1, ( ( temp_output_32_0_g632 * float2( 0,1 ) ) + temp_output_1_0_g632 ) );
			float temp_output_17_0_g632 = ( ( tex2D( _RippleTex1, ( ( float2( 1,0 ) * temp_output_32_0_g632 ) + temp_output_1_0_g632 ) ).r - tex2DNode8_g632.r ) * 1.0 );
			float temp_output_18_0_g632 = ( 1.0 * ( tex2DNode8_g632.r - tex2D( _RippleTex1, temp_output_1_0_g632 ).r ) );
			float2 appendResult21_g632 = (float2(temp_output_17_0_g632 , temp_output_18_0_g632));
			float3 appendResult27_g632 = (float3(( -appendResult21_g632 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g632 , 1.0 ) ) - pow( temp_output_18_0_g632 , 1.0 ) ) )));
			float3 normalizeResult28_g632 = normalize( appendResult27_g632 );
			float2 appendResult37_g624 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g624 = ase_worldNormal;
			float3 appendResult4_g640 = (float3(( ( (normalizeResult28_g632).xy * appendResult37_g624 ) + (temp_output_30_0_g624).xz ) , (temp_output_30_0_g624).y));
			float3 worldToTangentDir6_g640 = normalize( mul( ase_worldToTangent, (appendResult4_g640).xzy) );
			float temp_output_32_0_g634 = ( -0.02 / ( _Scale2 / 30.0 ) );
			...
			float2 temp_output_1_0_g634 = appendResult17_g622;
			float4 tex2DNode8_g634 = tex2D( _RippleTex2, ( ( temp_output_32_0_g634 * float2( 0,1 ) ) + temp_output_1_0_g634 ) );
			float temp_output_17_0_g634 = ( ( tex2D( _RippleTex2, ( ( float2( 1,0 ) * temp_output_32_0_g634 ) + temp_output_1_0_g634 ) ).r - tex2DNode8_g634.r ) * 1.0 );
			float temp_output_18_0_g634 = ( 1.0 * ( tex2DNode8_g634.r - tex2D( _RippleTex2, temp_output_1_0_g634 ).r ) );
			float2 appendResult21_g634 = (float2(temp_output_17_0_g634 , temp_output_18_0_g634));
			float3 appendResult27_g634 = (float3(( -appendResult21_g634 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g634 , 1.0 ) ) - pow( temp_output_18_0_g634 , 1.0 ) ) )));
			float3 normalizeResult28_g634 = normalize( appendResult27_g634 );
			float2 appendResult37_g622 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g622 = ase_worldNormal;
			float3 appendResult4_g641 = (float3(( ( (normalizeResult28_g634).xy * appendResult37_g622 ) + (temp_output_30_0_g622).xz ) , (temp_output_30_0_g622).y));
			float3 worldToTangentDir6_g641 = normalize( mul( ase_worldToTangent, (appendResult4_g641).xzy) );
			float temp_output_32_0_g631 = ( -0.02 / ( _Scale3 / 30.0 ) );
			float temp_output_1_0_g627 = _Scale3;
			...
			float2 appendResult17_g627 = (float2(( ( _XOffset3 / Scale10_g627 ) + break12_g627.x ) , ( break12_g627.y + ( _ZOffset3 / Scale10_g627 ) )));
			float2 temp_output_1_0_g631 = appendResult17_g627;
			float4 tex2DNode8_g631 = tex2D( _RippleTex3, ( ( temp_output_32_0_g631 * float2( 0,1 ) ) + temp_output_1_0_g631 ) );
			float temp_output_17_0_g631 = ( ( tex2D( _RippleTex3, ( ( float2( 1,0 ) * temp_output_32_0_g631 ) + temp_output_1_0_g631 ) ).r - tex2DNode8_g631.r ) * 1.0 );
			float temp_output_18_0_g631 = ( 1.0 * ( tex2DNode8_g631.r - tex2D( _RippleTex3, temp_output_1_0_g631 ).r ) );
			float2 appendResult21_g631 = (float2(temp_output_17_0_g631 , temp_output_18_0_g631));
			float3 appendResult27_g631 = (float3(( -appendResult21_g631 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g631 , 1.0 ) ) - pow( temp_output_18_0_g631 , 1.0 ) ) )));
			float3 normalizeResult28_g631 = normalize( appendResult27_g631 );
			float2 appendResult37_g627 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g627 = ase_worldNormal;
			float3 appendResult4_g637 = (float3(( ( (normalizeResult28_g631).xy * appendResult37_g627 ) + (temp_output_30_0_g627).xz ) , (temp_output_30_0_g627).y));
			float3 worldToTangentDir6_g637 = normalize( mul( ase_worldToTangent, (appendResult4_g637).xzy) );
			float3 lerpResult1528 = lerp( ( worldToTangentDir6_g639 + worldToTangentDir6_g640 + worldToTangentDir6_g641 + worldToTangentDir6_g637 ) , float3(0,0,1) , saturate( pow( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / 100.0 ) , 0.5 ) ));
			...
			float temp_output_32_0_g629 = ( -0.02 / ( 1.0 / 30.0 ) );
			float2 appendResult1_g621 = (float2(0.15 , 0.0));
			float2 appendResult1543 = (float2(max( -_RangeVector.x , 0.0 ) , max( -_RangeVector.y , 0.0 )));
			float2 RangeX1546 = appendResult1543;
			float2 appendResult1544 = (float2(min( -_RangeVector.z , 0.0 ) , min( -_RangeVector.w , 0.0 )));
			...
			float2 panner3_g621 = ( _Time.y * appendResult1_g621 + temp_output_1640_0);
			float2 temp_output_1643_0 = panner3_g621;
			float2 temp_output_1_0_g629 = temp_output_1643_0;
			float4 tex2DNode8_g629 = tex2D( _RandomMask, ( ( temp_output_32_0_g629 * float2( 0,1 ) ) + temp_output_1_0_g629 ) );
			float temp_output_17_0_g629 = ( ( tex2D( _RandomMask, ( ( float2( 1,0 ) * temp_output_32_0_g629 ) + temp_output_1_0_g629 ) ).r - tex2DNode8_g629.r ) * 1.0 );
			float temp_output_18_0_g629 = ( 1.0 * ( tex2DNode8_g629.r - tex2D( _RandomMask, temp_output_1_0_g629 ).r ) );
			float2 appendResult21_g629 = (float2(temp_output_17_0_g629 , temp_output_18_0_g629));
			float3 appendResult27_g629 = (float3(( -appendResult21_g629 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g629 , 1.0 ) ) - pow( temp_output_18_0_g629 , 1.0 ) ) )));
			float3 normalizeResult28_g629 = normalize( appendResult27_g629 );
			...
			float3 appendResult4_g638 = (float3(( ( (normalizeResult28_g629).xy * temp_output_1687_28 ) + temp_output_1687_26 ) , temp_output_1687_27));
			float3 worldToTangentDir6_g638 = normalize( mul( ase_worldToTangent, (appendResult4_g638).xzy) );
			float temp_output_32_0_g630 = ( -0.02 / ( 1.0 / 30.0 ) );
			float2 appendResult1_g628 = (float2(0.3 , 0.0));
			float cos1642 = cos( radians( 180.0 ) );
			float sin1642 = sin( radians( 180.0 ) );
			float2 rotator1642 = mul( temp_output_1640_0 - float2( 0.5,0.5 ) , float2x2( cos1642 , -sin1642 , sin1642 , cos1642 )) + float2( 0.5,0.5 );
			float2 panner3_g628 = ( _Time.y * appendResult1_g628 + rotator1642);
			float2 temp_output_1644_0 = panner3_g628;
			float2 temp_output_1_0_g630 = temp_output_1644_0;
			float4 tex2DNode8_g630 = tex2D( _RandomMask, ( ( temp_output_32_0_g630 * float2( 0,1 ) ) + temp_output_1_0_g630 ) );
			float temp_output_17_0_g630 = ( ( tex2D( _RandomMask, ( ( float2( 1,0 ) * temp_output_32_0_g630 ) + temp_output_1_0_g630 ) ).r - tex2DNode8_g630.r ) * 1.0 );
			float temp_output_18_0_g630 = ( 1.0 * ( tex2DNode8_g630.r - tex2D( _RandomMask, temp_output_1_0_g630 ).r ) );
			float2 appendResult21_g630 = (float2(temp_output_17_0_g630 , temp_output_18_0_g630));
			float3 appendResult27_g630 = (float3(( -appendResult21_g630 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g630 , 1.0 ) ) - pow( temp_output_18_0_g630 , 1.0 ) ) )));
			float3 normalizeResult28_g630 = normalize( appendResult27_g630 );
			float3 appendResult4_g636 = (float3(( ( (normalizeResult28_g630).xy * temp_output_1687_28 ) + temp_output_1687_26 ) , temp_output_1687_27));
			float3 worldToTangentDir6_g636 = normalize( mul( ase_worldToTangent, (appendResult4_g636).xzy) );
			float3 lerpResult1703 = lerp( ( worldToTangentDir6_g638 + worldToTangentDir6_g636 ) , _Vector14 , saturate( pow( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / 10.0 ) , 0.5 ) ));
			...
			float3 CurrentNormal23_g651 = normalize( (WorldNormalVector( i , appendResult735 )) );
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			float3 ase_worldlightDir = 0;
			#else //aseld
			float3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			float dotResult20_g651 = dot( CurrentNormal23_g651 , ase_worldlightDir );
			float NDotL21_g651 = dotResult20_g651;
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float3 AttenuationColor8_g651 = ( ase_lightColor.rgb * ase_lightAtten );
			...
			float2 appendResult1_g649 = (float2(_FoamSpeed , 0.0));
			float3 temp_output_21_0_g647 = ase_worldNormal;
			float temp_output_17_0_g647 = (temp_output_21_0_g647).y;
			float2 appendResult18_g647 = (float2(sign( temp_output_17_0_g647 ) , 1.0));
			float2 temp_output_1212_0 = ( ( appendResult18_g647 * (ase_worldPos).xz ) * _FoamTiling );
			float2 panner3_g649 = ( _Time.y * appendResult1_g649 + temp_output_1212_0);
			float2 appendResult1_g648 = (float2(_FoamSpeed , 0.0));
			...
			float2 panner3_g648 = ( _Time.y * appendResult1_g648 + rotator296);
			float3 desaturateInitialColor304 = ( tex2D( _FoamTexture, panner3_g649 ) - tex2D( _FoamTexture, panner3_g648 ) ).rgb;
			...
			float clampResult100_g651 = clamp( ase_worldlightDir.y , ( length( (UNITY_LIGHTMODEL_AMBIENT).rgb ) / 3.0 ) , 1.0 );
			float3 diffuseColor131_g651 = ( ( ( max( ( LightWrapVector47_g651 + ( ( 1.0 - LightWrapVector47_g651 ) * NDotL21_g651 ) ) , float3(0,0,0) ) * AttenuationColor8_g651 ) * foamyWater490.rgb ) * clampResult100_g651 );
			float3 normalizeResult77_g651 = normalize( ase_worldlightDir );
			float3 normalizeResult28_g651 = normalize( ( normalizeResult77_g651 + ase_worldViewDir ) );
			float3 HalfDirection29_g651 = normalizeResult28_g651;
			float dotResult32_g651 = dot( HalfDirection29_g651 , CurrentNormal23_g651 );
			float SpecularPower14_g651 = exp2( ( ( _Gloss * 10.0 ) + 1.0 ) );
			...
			float3 specularFinalColor42_g651 = ( AttenuationColor8_g651 * pow( max( dotResult32_g651 , 0.0 ) , SpecularPower14_g651 ) * specularity504.rgb );
			float3 diffuseSpecular132_g651 = ( diffuseColor131_g651 + specularFinalColor42_g651 );
			...
			float4 lerpResult87_g651 = lerp( screenColor86_g651 , float4( diffuseSpecular132_g651 , 0.0 ) , opacity508);
			c.rgb = ( lerpResult87_g651 * ase_lightAtten ).rgb;
			c.a = 1;
			return c;
		}
