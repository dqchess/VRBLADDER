Shader "AQUAS/Desktop/Back/Transparent Back"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult1_g616 = (float2(0.3 , 0.0));
			...
			float2 panner3_g616 = ( _Time.y * appendResult1_g616 + rotator1532);
			float2 temp_output_1534_0 = panner3_g616;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult1_g309 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g309 = ( _Time.y * appendResult1_g309 + rotator30);
			float normalStrength681 = _NormalStrength;
			float3 lerpResult67 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g311 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g309 ) ) ) , normalStrength681);
			float3 WavesCloseUV1207 = lerpResult67;
			float2 appendResult1_g305 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g305 = ( _Time.y * appendResult1_g305 + temp_output_1324_0);
			float2 appendResult1_g306 = (float2(waveSpeed675 , 0.0));
			...
			float2 panner3_g306 = ( _Time.y * appendResult1_g306 + rotator1327);
			float3 lerpResult1333 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g305 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g306 ) ) ) , normalStrength681);
			...
			float2 appendResult1_g249 = (float2(0.1 , 0.0));
			...
			float2 panner3_g249 = ( _Time.y * appendResult1_g249 + temp_output_1211_0);
			float2 appendResult1_g248 = (float2(0.2 , 0.0));
			...
			float2 panner3_g248 = ( _Time.y * appendResult1_g248 + rotator1177);
			float4 ShorelineNormal817 = ( float4( lerpResult824 , 0.0 ) * ( 1.0 - step( tex2DNode912.r , _ShorelineBlend ) ) * ( ( tex2D( _RandomMask1, panner3_g249 ) + tex2D( _RandomMask1, panner3_g248 ) ) / 2.0 ) );
			float4 NormalsClose1340 = ( float4( lerpResult1338 , 0.0 ) + ShorelineNormal817 );
			float temp_output_678_0 = ( waveSpeed675 / 10.0 );
			float2 appendResult1_g308 = (float2(temp_output_678_0 , 0.0));
			...
			float2 panner3_g308 = ( _Time.y * appendResult1_g308 + temp_output_1347_0);
			...
			float2 panner3_g312 = ( _Time.y * appendResult1_g312 + rotator630);
			...
			float3 lerpResult639 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g308 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g312 ) ) ) , normalStrengthMedium706);
			...
			float2 appendResult1_g307 = (float2(temp_output_1362_0 , 0.0));
			...
			float2 panner3_g307 = ( _Time.y * appendResult1_g307 + rotator1361);
			float3 lerpResult1367 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g310 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g307 ) ) ) , normalStrengthMedium706);
			...
			float2 appendResult1_g611 = (float2(temp_output_680_0 , 0.0));
			float2 temp_output_1201_0 = ( BaseUV1197 * ( normalTiling618 / 1200.0 ) );
			float2 panner3_g611 = ( _Time.y * appendResult1_g611 + temp_output_1201_0);
			float2 appendResult1_g612 = (float2(temp_output_680_0 , 0.0));
			...
			float2 panner3_g612 = ( _Time.y * appendResult1_g612 + rotator646);
			...
			float3 lerpResult657 = lerp( float3(0,0,1) , ( UnpackNormal( tex2D( _NormalTexture, panner3_g611 ) ) + UnpackNormal( tex2D( _NormalTexture, panner3_g612 ) ) ) , normalStrengthFar704);
			...
			float3 appendResult4_g634 = (float3(( ( (lerpResult670.rgb).xy * NormalSign1123 ) + WorldNormalXZ1122 ) , WorldNormalY1121));
			...
			float3 break1421 = worldToTangentDir6_g634;
			float temp_output_32_0_g623 = ( -0.02 / ( _Scale0 / 30.0 ) );
			float temp_output_1_0_g610 = _Scale0;
			float Scale10_g610 = temp_output_1_0_g610;
			float2 break12_g610 = ( ( (ase_worldPos).xz + ( float2( 0.5,0.5 ) * temp_output_1_0_g610 ) ) * ( 1.0 / temp_output_1_0_g610 ) );
			float2 appendResult17_g610 = (float2(( ( _XOffset0 / Scale10_g610 ) + break12_g610.x ) , ( break12_g610.y + ( _ZOffset0 / Scale10_g610 ) )));
			float2 temp_output_1_0_g623 = appendResult17_g610;
			float4 tex2DNode8_g623 = tex2D( _RippleTex0, ( ( temp_output_32_0_g623 * float2( 0,1 ) ) + temp_output_1_0_g623 ) );
			float temp_output_17_0_g623 = ( ( tex2D( _RippleTex0, ( ( float2( 1,0 ) * temp_output_32_0_g623 ) + temp_output_1_0_g623 ) ).r - tex2DNode8_g623.r ) * 1.0 );
			float temp_output_18_0_g623 = ( 1.0 * ( tex2DNode8_g623.r - tex2D( _RippleTex0, temp_output_1_0_g623 ).r ) );
			...
			float2 appendResult37_g610 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g610 = ase_worldNormal;
			float3 appendResult4_g628 = (float3(( ( (normalizeResult28_g623).xy * appendResult37_g610 ) + (temp_output_30_0_g610).xz ) , (temp_output_30_0_g610).y));
			float3 worldToTangentDir6_g628 = normalize( mul( ase_worldToTangent, (appendResult4_g628).xzy) );
			float temp_output_32_0_g622 = ( -0.02 / ( _Scale1 / 30.0 ) );
			float temp_output_1_0_g613 = _Scale1;
			float Scale10_g613 = temp_output_1_0_g613;
			float2 break12_g613 = ( ( (ase_worldPos).xz + ( float2( 0.5,0.5 ) * temp_output_1_0_g613 ) ) * ( 1.0 / temp_output_1_0_g613 ) );
			float2 appendResult17_g613 = (float2(( ( _XOffset1 / Scale10_g613 ) + break12_g613.x ) , ( break12_g613.y + ( _ZOffset1 / Scale10_g613 ) )));
			float2 temp_output_1_0_g622 = appendResult17_g613;
			float4 tex2DNode8_g622 = tex2D( _RippleTex1, ( ( temp_output_32_0_g622 * float2( 0,1 ) ) + temp_output_1_0_g622 ) );
			float temp_output_17_0_g622 = ( ( tex2D( _RippleTex1, ( ( float2( 1,0 ) * temp_output_32_0_g622 ) + temp_output_1_0_g622 ) ).r - tex2DNode8_g622.r ) * 1.0 );
			float temp_output_18_0_g622 = ( 1.0 * ( tex2DNode8_g622.r - tex2D( _RippleTex1, temp_output_1_0_g622 ).r ) );
			float2 appendResult21_g622 = (float2(temp_output_17_0_g622 , temp_output_18_0_g622));
			float3 appendResult27_g622 = (float3(( -appendResult21_g622 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g622 , 1.0 ) ) - pow( temp_output_18_0_g622 , 1.0 ) ) )));
			float3 normalizeResult28_g622 = normalize( appendResult27_g622 );
			float2 appendResult37_g613 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g613 = ase_worldNormal;
			float3 appendResult4_g626 = (float3(( ( (normalizeResult28_g622).xy * appendResult37_g613 ) + (temp_output_30_0_g613).xz ) , (temp_output_30_0_g613).y));
			float3 worldToTangentDir6_g626 = normalize( mul( ase_worldToTangent, (appendResult4_g626).xzy) );
			float temp_output_32_0_g618 = ( -0.02 / ( _Scale2 / 30.0 ) );
			float temp_output_1_0_g609 = _Scale2;
			float Scale10_g609 = temp_output_1_0_g609;
			float2 break12_g609 = ( ( (ase_worldPos).xz + ( float2( 0.5,0.5 ) * temp_output_1_0_g609 ) ) * ( 1.0 / temp_output_1_0_g609 ) );
			float2 appendResult17_g609 = (float2(( ( _XOffset2 / Scale10_g609 ) + break12_g609.x ) , ( break12_g609.y + ( _ZOffset2 / Scale10_g609 ) )));
			float2 temp_output_1_0_g618 = appendResult17_g609;
			float4 tex2DNode8_g618 = tex2D( _RippleTex2, ( ( temp_output_32_0_g618 * float2( 0,1 ) ) + temp_output_1_0_g618 ) );
			float temp_output_17_0_g618 = ( ( tex2D( _RippleTex2, ( ( float2( 1,0 ) * temp_output_32_0_g618 ) + temp_output_1_0_g618 ) ).r - tex2DNode8_g618.r ) * 1.0 );
			float temp_output_18_0_g618 = ( 1.0 * ( tex2DNode8_g618.r - tex2D( _RippleTex2, temp_output_1_0_g618 ).r ) );
			float2 appendResult21_g618 = (float2(temp_output_17_0_g618 , temp_output_18_0_g618));
			float3 appendResult27_g618 = (float3(( -appendResult21_g618 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g618 , 1.0 ) ) - pow( temp_output_18_0_g618 , 1.0 ) ) )));
			float3 normalizeResult28_g618 = normalize( appendResult27_g618 );
			float2 appendResult37_g609 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g609 = ase_worldNormal;
			float3 appendResult4_g625 = (float3(( ( (normalizeResult28_g618).xy * appendResult37_g609 ) + (temp_output_30_0_g609).xz ) , (temp_output_30_0_g609).y));
			float3 worldToTangentDir6_g625 = normalize( mul( ase_worldToTangent, (appendResult4_g625).xzy) );
			float temp_output_32_0_g619 = ( -0.02 / ( _Scale3 / 30.0 ) );
			float temp_output_1_0_g614 = _Scale3;
			float Scale10_g614 = temp_output_1_0_g614;
			float2 break12_g614 = ( ( (ase_worldPos).xz + ( float2( 0.5,0.5 ) * temp_output_1_0_g614 ) ) * ( 1.0 / temp_output_1_0_g614 ) );
			float2 appendResult17_g614 = (float2(( ( _XOffset3 / Scale10_g614 ) + break12_g614.x ) , ( break12_g614.y + ( _ZOffset3 / Scale10_g614 ) )));
			float2 temp_output_1_0_g619 = appendResult17_g614;
			float4 tex2DNode8_g619 = tex2D( _RippleTex3, ( ( temp_output_32_0_g619 * float2( 0,1 ) ) + temp_output_1_0_g619 ) );
			float temp_output_17_0_g619 = ( ( tex2D( _RippleTex3, ( ( float2( 1,0 ) * temp_output_32_0_g619 ) + temp_output_1_0_g619 ) ).r - tex2DNode8_g619.r ) * 1.0 );
			float temp_output_18_0_g619 = ( 1.0 * ( tex2DNode8_g619.r - tex2D( _RippleTex3, temp_output_1_0_g619 ).r ) );
			float2 appendResult21_g619 = (float2(temp_output_17_0_g619 , temp_output_18_0_g619));
			float3 appendResult27_g619 = (float3(( -appendResult21_g619 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g619 , 1.0 ) ) - pow( temp_output_18_0_g619 , 1.0 ) ) )));
			float3 normalizeResult28_g619 = normalize( appendResult27_g619 );
			float2 appendResult37_g614 = (float2(0.0 , 1.0));
			float3 temp_output_30_0_g614 = ase_worldNormal;
			float3 appendResult4_g624 = (float3(( ( (normalizeResult28_g619).xy * appendResult37_g614 ) + (temp_output_30_0_g614).xz ) , (temp_output_30_0_g614).y));
			float3 worldToTangentDir6_g624 = normalize( mul( ase_worldToTangent, (appendResult4_g624).xzy) );
			float3 lerpResult1414 = lerp( ( worldToTangentDir6_g628 + worldToTangentDir6_g626 + worldToTangentDir6_g625 + worldToTangentDir6_g624 ) , float3(0,0,1) , saturate( pow( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / 100.0 ) , 0.5 ) ));
			...
			float temp_output_32_0_g621 = ( -0.02 / ( 1.0 / 30.0 ) );
			float2 appendResult1_g615 = (float2(0.15 , 0.0));
			float2 appendResult1435 = (float2(max( -_RangeVector.x , 0.0 ) , max( -_RangeVector.y , 0.0 )));
			float2 RangeX1436 = appendResult1435;
			float2 appendResult1434 = (float2(min( -_RangeVector.z , 0.0 ) , min( -_RangeVector.w , 0.0 )));
			...
			float2 panner3_g615 = ( _Time.y * appendResult1_g615 + temp_output_1531_0);
			float2 temp_output_1535_0 = panner3_g615;
			float2 temp_output_1_0_g621 = temp_output_1535_0;
			float4 tex2DNode8_g621 = tex2D( _RandomMask1, ( ( temp_output_32_0_g621 * float2( 0,1 ) ) + temp_output_1_0_g621 ) );
			float temp_output_17_0_g621 = ( ( tex2D( _RandomMask1, ( ( float2( 1,0 ) * temp_output_32_0_g621 ) + temp_output_1_0_g621 ) ).r - tex2DNode8_g621.r ) * 1.0 );
			float temp_output_18_0_g621 = ( 1.0 * ( tex2DNode8_g621.r - tex2D( _RandomMask1, temp_output_1_0_g621 ).r ) );
			float2 appendResult21_g621 = (float2(temp_output_17_0_g621 , temp_output_18_0_g621));
			float3 appendResult27_g621 = (float3(( -appendResult21_g621 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g621 , 1.0 ) ) - pow( temp_output_18_0_g621 , 1.0 ) ) )));
			float3 normalizeResult28_g621 = normalize( appendResult27_g621 );
			float3 temp_output_21_0_g617 = ase_worldNormal;
			float temp_output_17_0_g617 = (temp_output_21_0_g617).y;
			float2 appendResult18_g617 = (float2(sign( temp_output_17_0_g617 ) , 1.0));
			float2 temp_output_1538_28 = appendResult18_g617;
			float2 temp_output_1538_26 = (temp_output_21_0_g617).xz;
			float temp_output_1538_27 = temp_output_17_0_g617;
			float3 appendResult4_g629 = (float3(( ( (normalizeResult28_g621).xy * temp_output_1538_28 ) + temp_output_1538_26 ) , temp_output_1538_27));
			float3 worldToTangentDir6_g629 = normalize( mul( ase_worldToTangent, (appendResult4_g629).xzy) );
			float temp_output_32_0_g620 = ( -0.02 / ( 1.0 / 30.0 ) );
			float2 appendResult1_g616 = (float2(0.3 , 0.0));
			float cos1532 = cos( radians( 180.0 ) );
			float sin1532 = sin( radians( 180.0 ) );
			float2 rotator1532 = mul( temp_output_1531_0 - float2( 0.5,0.5 ) , float2x2( cos1532 , -sin1532 , sin1532 , cos1532 )) + float2( 0.5,0.5 );
			float2 panner3_g616 = ( _Time.y * appendResult1_g616 + rotator1532);
			float2 temp_output_1534_0 = panner3_g616;
			float2 temp_output_1_0_g620 = temp_output_1534_0;
			float4 tex2DNode8_g620 = tex2D( _RandomMask1, ( ( temp_output_32_0_g620 * float2( 0,1 ) ) + temp_output_1_0_g620 ) );
			float temp_output_17_0_g620 = ( ( tex2D( _RandomMask1, ( ( float2( 1,0 ) * temp_output_32_0_g620 ) + temp_output_1_0_g620 ) ).r - tex2DNode8_g620.r ) * 1.0 );
			float temp_output_18_0_g620 = ( 1.0 * ( tex2DNode8_g620.r - tex2D( _RandomMask1, temp_output_1_0_g620 ).r ) );
			float2 appendResult21_g620 = (float2(temp_output_17_0_g620 , temp_output_18_0_g620));
			float3 appendResult27_g620 = (float3(( -appendResult21_g620 * float2( 3,3 ) ) , sqrt( ( ( 1.0 - pow( temp_output_17_0_g620 , 1.0 ) ) - pow( temp_output_18_0_g620 , 1.0 ) ) )));
			float3 normalizeResult28_g620 = normalize( appendResult27_g620 );
			float3 appendResult4_g627 = (float3(( ( (normalizeResult28_g620).xy * temp_output_1538_28 ) + temp_output_1538_26 ) , temp_output_1538_27));
			float3 worldToTangentDir6_g627 = normalize( mul( ase_worldToTangent, (appendResult4_g627).xzy) );
			float3 lerpResult1544 = lerp( ( worldToTangentDir6_g629 + worldToTangentDir6_g627 ) , _Vector16 , saturate( pow( ( distance( ase_worldPos , _WorldSpaceCameraPos ) / 10.0 ) , 0.5 ) ));
